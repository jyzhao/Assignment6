...
public class AddUserAccountJPanel extends javax.swing.JPanel {
    ...
    public AddUserAccountJPanel(JPanel upc, SupplierDirectory supplierDirectory, CustomerDirectory customerDirectory, UserAccountDirectory userAccountDirectory) {
        initComponents();
        this.upc = upc;
    ...
    private void createUserAccountJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserAccountJButtonActionPerformed
        ...
        if (ua.getRole().equals(UserAccount.SUPPLIER_ROLE)) {
            ua.setPerson((Supplier) personJComboBox.getSelectedItem());
        } else if (ua.getRole().equals(UserAccount.CUSTOMER_ROLE)) {
            ua.setPerson((Customer) personJComboBox.getSelectedItem());
        }
